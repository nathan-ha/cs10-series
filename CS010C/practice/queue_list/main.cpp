...
int main()
{
   ...
   //tests pop from an empty stack_list
   if (test == 3) {
       try{
          cout << "\nstack3 constructor called";
          stack_list<int> stack3;
          cout<<"\npop from empty stack_list\n";
          stack3.pop();
          cout << endl;
       }
       catch(underflow_error & e){
   ...
   //tests push to a full stack_list
   if (test == 4) {
       try{
          cout << "\nstack4 constructor called";
          stack_list<int> stack4;
          cout << "\npush 20 elements";
          for(int i = 1; i <=20; ++i){
              stack4.push(i);
          }
   ...
   //tests stack_list of strings
   if (test == 5) {
       try{
          cout << "\nstack5 constructor called";
          stack_list<string> stack5;
          cout << "\npush A";
          stack5.push("A");
          cout << "\npush B";
          stack5.push("B");
